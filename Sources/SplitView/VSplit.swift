...
public struct VSplit<P: View, D: SplitDivider, S: View>: View {
    ...
    public init(@ViewBuilder top: @escaping ()->P, @ViewBuilder bottom: @escaping ()->S) where D == Splitter {
        ...
        self.init(fractionSeed: fraction, explicitFraction: nil, hide: hide, constraints: constraints, onDrag: nil, primary: { top() }, splitter: { D() }, secondary: { bottom() })
    }
    ...
    public func splitter<T>(@ViewBuilder _ splitter: @escaping ()->T) -> VSplit<P, T, S> where T: View {
        return VSplit<P, T, S>(fractionSeed: fractionSeed, explicitFraction: explicitFraction, hide: hide, constraints: constraints, onDrag: onDrag, primary: { primary }, splitter: splitter, secondary: { secondary })
    }
    ...
    public func constraints(minPFraction: CGFloat? = nil, minSFraction: CGFloat? = nil, priority: SplitSide? = nil, dragToHideP: Bool = false, dragToHideS: Bool = false) -> VSplit {
        ...
        return VSplit(fractionSeed: fractionSeed, explicitFraction: explicitFraction, hide: hide, constraints: constraints, onDrag: onDrag, primary: { primary }, splitter: { splitter }, secondary: { secondary })
    }
    ...
    public func onDrag(_ callback: ((CGFloat)->Void)?) -> VSplit {
        return VSplit(fractionSeed: fractionSeed, explicitFraction: explicitFraction, hide: hide, constraints: constraints, onDrag: callback, primary: { primary }, splitter: { splitter }, secondary: { secondary })
    }
    ...
    public func fraction(_ fraction: FractionHolder) -> VSplit<P, D, S> {
        VSplit(fractionSeed: fractionSeed, explicitFraction: fraction, hide: hide, constraints: constraints, onDrag: onDrag, primary: { primary }, splitter: { splitter }, secondary: { secondary })
    }
    ...
    public func fraction(_ fraction: CGFloat) -> VSplit<P, D, S> {
        VSplit(fractionSeed: FractionHolder(fraction), explicitFraction: nil, hide: hide, constraints: constraints, onDrag: onDrag, primary: { primary }, splitter: { splitter }, secondary: { secondary })
    }

    /// Return a new instance of VSplit with `hide` set to this SideHolder
    public func hide(_ side: SideHolder) -> VSplit<P, D, S> {
        VSplit(fractionSeed: fractionSeed, explicitFraction: explicitFraction, hide: side, constraints: constraints, onDrag: onDrag, primary: { primary }, splitter: { splitter }, secondary: { secondary })
    }
